...
const Navbar = () => {
  ...
  return (
    ...
    <div className="content-between p-6 sm:px-16 flex justify-between items-center">
      <div><a href="https://github.com/Dhaou-Jawhar" className="flex"><img src="/github.svg" className="mr-1" alt="" height={30} width={30} /><div className="text-xl font-bold cursor-pointer">Jawhar</div></a> </div>
    ...
    {modal && <div className="modal p-4 bg-gray-800 left-1/4 rounded-md border shadow-2xl backdrop-blur-lg bg-opacity-40 border-gray-700 z-10 w-6/12 m-auto absolute h-80">
      ...
      <div className="text-gray-400">Learning about Local storage and Session Storage. I will implement this as soon as Possible</div>
    </div>
